...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <button type="button" class="btn btn-default btn-lg"><a href="{{ url('/register/mentor') }}">Registreren als Begeleider</a></button>
            <button type="button" class="btn btn-default btn-lg active"><a href="{{ url('/register') }}">Registeren als Familie/persoon</a></button>
            <br />
            <br />
            <div class="panel panel-default">
                <div class="panel-heading">Registreren als hulpverlener/begeleider</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="housenumber" value="{{ old('housenumber') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="zip" value="{{ old('zip') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Stad</label>
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Telefoonnummer</label>
